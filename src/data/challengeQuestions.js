export const challengeQuestions = [
  {
    ...
    options: [
      ...
      { text: "Để ăn trực tiếp thay kẹo mút", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Bánh ngọt sô-cô-la", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Quần áo ấm mặc mùa đông", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Đòi bố mẹ vô cớ", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Để đập vỡ nghịch cho vui tai", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Lên kế hoạch tiết kiệm tiền dần dần", isCorrect: true }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Nơi chỉ để chụp ảnh check-in", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Giấu tiền đi không cho ai biết", isCorrect: false }
    ],
    reward: 10
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Là bắt người khác cho mình đồ", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Nó chỉ là một món đồ chơi bằng nhựa", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Vì bánh kẹo ăn không ngon", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Tiền mua kẹo của nhân viên ngân hàng", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Mua đồ đắt tiền nhất", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Tiêu hết tiền ngay lập tức", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Làm hỏng rồi không nhận lỗi", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Mệnh giá in trên tờ tiền", isCorrect: true }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Để người lớn có tiền đi chơi", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Để dạy con học bài", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Khi thấy buồn chán", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Để tiền bừa bãi trên bàn", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Bỏ đi mua ví mới", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Để cãi nhau nhiều hơn", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Ném đi khắp nhà", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Không tốt vì đồ giảm giá đều là đồ hỏng", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Chi tiêu vượt quá số tiền mình có", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Để mua đắt hơn", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Để vòi nước chảy tự do", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Để mua được nhiều quà cáp miễn phí", isCorrect: false }
    ],
    reward: 10
  },
  {
    ...
    options: [
      ...
      { text: "Người có nhiều đồ chơi đắt tiền nhất nhưng không biết tiết kiệm", isCorrect: false }
    ],
    reward: 10
  }
];
